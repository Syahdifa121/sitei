            ...
            <td class="text-center">
                <div class="d-flex gap-2 justify-content-center">
                    <button type="button" class="btn btn-info btn-sm btn-detail-alumni"
                        ...
                        data-nim="${alumni.nim || ''}"
                        data-tahun-lulus="${alumni.graduationYear || ''}"
                        data-no-telepon="${alumni.phone || ''}"
                        data-alamat="${alumni.address || ''}"
                        data-nama-perusahaan="${alumni.company || ''}"
                        data-provinsi="${alumni.province || ''}"
                        data-kota="${alumni.city || ''}"
                        data-created-at="${alumni.createdAt || ''}">
